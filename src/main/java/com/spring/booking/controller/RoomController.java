...
public class RoomController {
    ...
    public String uploadRoom(@ModelAttribute RoomEntity roomEntity, MultipartFile file,
        ...
        try {
            String image =  FileUploader.uploadFile(file,"D:\\Hoang\\TestBooking\\test-booking\\src\\main\\webapp\\resources\\img");
            roomEntity.setPhoto(image);
            roomRepository.save(roomEntity);
            return "redirect:/home";
        }catch (Exception ex){
            model.addAttribute("msg","Loi he thong"+ex.toString());
            return "error";
        }
